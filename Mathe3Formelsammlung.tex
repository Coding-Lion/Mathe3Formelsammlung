...
\usepackage{mystyle, pgfplots, amssymb, todonotes}
...
\begin{tabularx}{\textwidth}{XXX}
  ...
  Zeitverschiebung: \mybfred{Wenn nach rechts verschoben wird ist Exponent negativ!} & \(s(t-t_0)\) & \(e^{- \im 2\pi f t_0} S(f)\)\\
